      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex flex-col md:flex-row justify-between items-center space-y-6 md:space-y-0">
          ...
          <div className="text-sm text-gray-600 animate-fade-in">
            © {currentYear} Alexandros Liakos. All rights reserved.
          </div>

          {/* Quick Links */}
          <div className="flex flex-wrap justify-center gap-6 text-sm">
            {['/', '/celebrities', '/gino-salon', '/contact'].map((href, index) => {
              const labels: Record<string, string> = {
                '/': 'Home',
                '/celebrities': 'Celebrities',
                '/gino-salon': 'Gino Salon',
                '/contact': 'Contact',
              }
              return (
                <Link
                  ...
                  className="text-gray-600 hover:text-accent transition-all duration-300 relative group animate-fade-in-up"
                >
                  {labels[href]}
          ...
          <div className="flex items-center space-x-4">
            {[
              ...
              <a
                ...
                style={{ animationDelay: `${index * 0.1}s` }}
                className="text-gray-600 hover:text-accent transition-all duration-300 p-2 rounded-full hover:bg-gray-100/50 group animate-fade-in-up"
